...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.i_start = self.start.clone()
        self.i_end = self.end.clone()
    ...
    def length(self):
        ...
        length = math.sqrt(dx_squared + dy_squared)
    ...
    def is_parallel(self, line2):
        ...
        slope_self = Line.slope(self)
        slope_line2 = Line.slope(line2)

        if round(slope_self, 12) == round(slope_line2, 12):
            return True
        else:
            return False
